...
- Caller-save registers that can be modified during a function call.
  ...
  We follow the LoongArch application binary interface (ABI) in our choice
  of callee- and caller-save registers.
*)

Definition is_callee_save (r: mreg) : bool :=
  match r with
  | R4 | R5 | R6 | R7 | R8 | R9 | R10 | R11 | R12 | R13 | R14 | R15 | R16 | R17 | R18 | R19 => false
  | R23 | R24 | R25 | R26 | R27 | R28 | R29 | R30 | R31 => true
  | F0 | F1 | F2 | F3 | F4 | F5 | F6 | F7 | F8 | F9 | F10 | F11 | F12 | F13 | F14 | F15 | F16 | F17 | F18 | F19 | F20 | F21 | F22 | F23 => false
  | F24 | F25 | F26 | F27 | F28 | F29 | F30 | F31 => true
  end.

Definition int_caller_save_regs :=
  R4 :: R5 :: R6 :: R7 :: R8 :: R9 :: R10 :: R11 :: R12 :: R13 :: R14 :: R15 :: R16 :: R17 :: R18 :: R19 :: nil.
...
(** The functions in this section determine the locations (machine registers
  ...
  implement the standard LoongArch conventions as found here:
...
(** The result value of a function is passed back to the caller in
  registers [R4] or [F0] or [R4,R5], depending on the type of the
...
Definition loc_result (s: signature) : rpair mreg :=
  ...
  | Tlong => if Archi.ptr64 then One R4 else Twolong R5 R4
  end.
...
(** The LoongArch ABI states the following conventions for passing arguments
  to a function.  First for non-variadic functions:

- LA64: pass the first 8 integer arguments in integer registers
...
- LA32: same, but arguments of size 64 bits that must be passed in
...
- LA64: FP registers are not used for passing variadic arguments.
...
- LA32: likewise, but arguments of 64-bit types (integers as well
