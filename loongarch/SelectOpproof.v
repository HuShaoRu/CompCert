...
- TrivialExists.
- exists (Val.or v1 v0); split; auto. EvalOp.
- exists (Val.or v0 (Val.notint v1)); split. EvalOp. 
  destruct v0; destruct v1; simpl; auto.
  rewrite Int.not_and_or_not, Int.not_involutive, Int.or_commut. auto.
- exists (Val.and v0 (Val.notint v1)); split. EvalOp. 
  destruct v0; destruct v1; simpl; auto.
  rewrite Int.not_or_and_not, Int.not_involutive, Int.and_commut. auto.
- TrivialExists. simpl. rewrite Val.not_xor. rewrite Val.xor_assoc. auto.
- TrivialExists.
Qed.
