...
Proof.
  ...
  red; intros until x; case (notl_match a); intros; InvEval; subst.
- TrivialExists.
- exists v1; split; auto.
- TrivialExists.
- exists (Val.orl v1 v0); split; auto. EvalOp.
- exists (Val.orl v0 (Val.notl v1)); split. EvalOp.
  destruct v0; destruct v1; simpl; auto.
  rewrite Int64.not_and_or_not, Int64.not_involutive, Int64.or_commut. auto.
- exists (Val.andl v0 (Val.notl v1)); split. EvalOp.
  destruct v0; destruct v1; simpl; auto.
